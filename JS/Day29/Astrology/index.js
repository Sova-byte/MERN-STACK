...
form.addEventListener('submit', (e) => {
    ...
    res.textContent = `Welcome ${first_name} ${last_name}, the stars have a special message just for you as a ${zodiacSigns[month-1]}! ${compliments[day-1]} ${victimCardCompliments[year%20]} ${recommendations[(day*month)%30]} ${predictions[(first_name.length*last_name.length)%20]} `
})